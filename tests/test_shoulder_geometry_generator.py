...
class ShoulderGeometryGeneratorTests(unittest.TestCase):
    def test_script_creates_two_separate_review_shoulders(self) -> None:
        ...
        self.assertIn("ptr-shoulder-geometry-v3", script)
        ...
        self.assertIn("BASE_RADIUS_MM = 0.72", script)
        self.assertIn("TOP_RADIUS_MM = 0.50", script)
        self.assertIn("[0.0, 0.28, 0.72, 1.0]", script)
